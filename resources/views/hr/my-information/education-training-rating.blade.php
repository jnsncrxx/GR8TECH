@extends('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'hr.my-information.education-training-rating'])
...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3 mb-2">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Your academic and development records</p>
        </div>
    </div>
    ...
    <div class="emp-card sec-mfg">
        ...
        <div class="emp-card-body">
            ...
            <p class="text-xs text-gray-500 mt-3">
                Education, training, and rating records are not yet stored in the database on this system, so this
                section mirrors the admin layout but isn't wired up to save data yet.
            </p>
        </div>
    </div>
    @endif
