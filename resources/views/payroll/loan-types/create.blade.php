...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-semibold text-gray-900 mt-2">New Loan Type</h1>
        </div>
        ...
        <form action="{{ route('loan-types.store') }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-5">
            @csrf
            @include('payroll.loan-types._form')
