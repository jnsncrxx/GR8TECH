    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
        <form method="GET" action="{{ route('attendance.timekeeping') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select name="status" id="status" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors bg-white text-gray-900" style="background-color: white !important; color: #111827 !important;">
                    <option value="" style="color: #111827 !important;">All Statuses</option>
                    <option value="present" {{ request('status') == 'present' ? 'selected' : '' }} style="color: #111827 !important;">Present</option>
                    <option value="late" {{ request('status') == 'late' ? 'selected' : '' }} style="color: #111827 !important;">Late</option>
                    <option value="absent" {{ request('status') == 'absent' ? 'selected' : '' }} style="color: #111827 !important;">Absent</option>
                    <option value="half_day" {{ request('status') == 'half_day' ? 'selected' : '' }} style="color: #111827 !important;">Half Day</option>
                    <option value="on_leave" {{ request('status') == 'on_leave' ? 'selected' : '' }} style="color: #111827 !important;">On Leave</option>
                    <option value="official_business" {{ request('status') == 'official_business' ? 'selected' : '' }} style="color: #111827 !important;">Official Business</option>
                </select>
            </div>
    </div>
