...
(function() {
    ...
    <div class="mb-6 sm:mb-8">
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 text-center text-white shadow-lg mb-4">
            ...
            <?php if($todayAttendance && $todayAttendance->hasActiveTimeEntry()): ?>
                <div class="mt-4 pt-4 border-t border-blue-400">
                    ...
                    <?php if($activeEntry): ?>
                        <script>
                            window.activeSessionStart = "<?php echo e($activeEntry->time_in->toIso8601String()); ?>";
                        </script>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.dashboard-base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Xzanderyiel\Desktop\GR8TECH_Payroll-master\resources\views/dashboards/employee.blade.php ENDPATH**/ ?>