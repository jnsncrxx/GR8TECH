        ...
        <div class="text-center">
            ...
            <?php if($user->employee): ?>
                <div class="mt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <div class="inline-flex items-center bg-white dark:bg-slate-800 px-4 py-2 rounded-full">
                        <i class="fas fa-user text-blue-600 dark:text-blue-300 mr-2"></i>
                        <span class="text-slate-900 dark:text-slate-100 font-medium"><?php echo e($user->employee->first_name); ?> <?php echo e($user->employee->last_name); ?></span>
                        <?php if($user->employee->department): ?>
                            <span class="text-slate-500 dark:text-slate-300 ml-2">• <?php echo e($user->employee->department->name); ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="inline-flex items-center bg-white dark:bg-slate-800 px-4 py-2 rounded-full">
                        <i class="fas fa-id-badge text-green-600 dark:text-emerald-300 mr-2"></i>
                        <span class="text-slate-900 dark:text-slate-100 font-medium">Employee ID: <?php echo e($user->employee->employee_id); ?></span>
                    </div>
                    <?php if($todayAttendance): ?>
                        <div class="inline-flex items-center bg-white dark:bg-slate-800 px-4 py-2 rounded-full">
                            <i class="fas fa-clock text-blue-600 dark:text-blue-300 mr-2"></i>
                            <span class="text-slate-900 dark:text-slate-100 font-medium">Status: <?php echo e(ucfirst($todayAttendance->status)); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'attendance.time-in-out'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Xzanderyiel\Desktop\GR8TECH_Payroll-master\resources\views/attendance/time-in-out.blade.php ENDPATH**/ ?>