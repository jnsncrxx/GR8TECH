<?php $__env->startSection('title', 'Create New Period'); ?>
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <form method="POST" action="<?php echo e(route('attendance.period-management.store')); ?>" class="p-6 space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                          placeholder="Add a description for this period..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                    <a href="<?php echo e(route('attendance.period-management.index')); ?>" class="px-4 py-2 border border-gray-300 rounded-lg font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                        Cancel
                    </a>
...
let allEmployees = <?php echo json_encode($employees, 15, 512) ?>;
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'attendance.period-management.index'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\GR8TECH-\resources\views/attendance/period-management/create.blade.php ENDPATH**/ ?>