    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="text-center">
                    <?php if(!empty($photoUrl)): ?>
                        <div class="w-32 h-32 mx-auto mb-4 overflow-hidden rounded-full border border-gray-200">
                            <img src="<?php echo e($photoUrl); ?>" alt="Profile photo" class="w-full h-full object-cover">
                        </div>
                    <?php else: ?>
                ...
                <form method="POST" action="<?php echo e(route('hr.profile.photo.upload')); ?>" enctype="multipart/form-data" class="mt-6 space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
...
<?php echo $__env->make('layouts.dashboard-base', ['user' => $user, 'activeRoute' => 'hr.profile'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Xzanderyiel\Desktop\GR8TECH_Payroll-master\resources\views/hr/profile.blade.php ENDPATH**/ ?>