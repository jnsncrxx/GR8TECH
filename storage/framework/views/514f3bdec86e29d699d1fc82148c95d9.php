    ...
    <div class="space-y-2">
        ...
        <div class="relative" x-data="{ 
            ...
            <div x-show="open" 
                ...
                <a href="<?php echo e(route('attendance.time-in-out')); ?>" 
                   class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-white hover:text-blue-600 rounded-md transition-all duration-200 group <?php echo e($activeRoute === 'attendance.time-in-out' ? 'bg-white text-blue-600' : ''); ?>">
                    <i class="fas fa-sign-in-alt mr-3 text-sm text-gray-400 group-hover:text-blue-600 <?php echo e($activeRoute === 'attendance.time-in-out' ? 'text-blue-600' : ''); ?>"></i>
                ...
                <!-- Attendance Record -->
                <a href="<?php echo e(route('attendance.daily')); ?>" 
                   class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-white hover:text-blue-600 rounded-md transition-all duration-200 group <?php echo e($activeRoute === 'attendance.daily' ? 'bg-white text-blue-600' : ''); ?>">
                    <i class="fas fa-calendar-day mr-3 text-sm text-gray-400 group-hover:text-blue-600 <?php echo e($activeRoute === 'attendance.daily' ? 'text-blue-600' : ''); ?>"></i>
                    <span>Attendance Record</span>
                </a>
                
                <!-- Timekeeping -->
                <a href="<?php echo e(route('attendance.timekeeping')); ?>" 
                   class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-white hover:text-blue-600 rounded-md transition-all duration-200 group <?php echo e($activeRoute === 'attendance.timekeeping' ? 'bg-white text-blue-600' : ''); ?>">
                    <i class="fas fa-stopwatch mr-3 text-sm text-gray-400 group-hover:text-blue-600 <?php echo e($activeRoute === 'attendance.timekeeping' ? 'text-blue-600' : ''); ?>"></i>
                    <span>Timekeeping</span>
                </a>
                
                <!-- Import DTR -->
                <a href="<?php echo e(route('attendance.import-dtr')); ?>" 
                   class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-white hover:text-blue-600 rounded-md transition-all duration-200 group <?php echo e($activeRoute === 'attendance.import-dtr' ? 'bg-white text-blue-600' : ''); ?>">
                    <i class="fas fa-file-import mr-3 text-sm text-gray-400 group-hover:text-blue-600 <?php echo e($activeRoute === 'attendance.import-dtr' ? 'text-blue-600' : ''); ?>"></i>
                ...
                <!-- Schedule Management -->
                <?php if($user->role !== 'employee'): ?>
                <a href="<?php echo e(route('schedule-v2.index')); ?>" 
                   class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-white hover:text-blue-600 rounded-md transition-all duration-200 group <?php echo e($activeRoute === 'schedule-v2.index' ? 'bg-white text-blue-600' : ''); ?>">
                    <i class="fas fa-calendar-plus mr-3 text-sm text-gray-400 group-hover:text-blue-600 <?php echo e($activeRoute === 'schedule-v2.index' ? 'text-blue-600' : ''); ?>"></i>
                    <span>Schedule Management</span>
                </a>
                <?php endif; ?>
                
                <!-- Overtime -->
                <a href="<?php echo e(route('attendance.overtime')); ?>" 
                   class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-white hover:text-blue-600 rounded-md transition-all duration-200 group <?php echo e($activeRoute === 'attendance.overtime' ? 'bg-white text-blue-600' : ''); ?>">
                    <i class="fas fa-clock mr-3 text-sm text-gray-400 group-hover:text-blue-600 <?php echo e($activeRoute === 'attendance.overtime' ? 'text-blue-600' : ''); ?>"></i>
                    <span>Overtime</span>
                </a>
                
                <!-- Leave Management -->
                <a href="<?php echo e(route('attendance.leave-management')); ?>" 
                   class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-white hover:text-blue-600 rounded-md transition-all duration-200 group <?php echo e($activeRoute === 'attendance.leave-management' ? 'bg-white text-blue-600' : ''); ?>">
                    <i class="fas fa-calendar-times mr-3 text-sm text-gray-400 group-hover:text-blue-600 <?php echo e($activeRoute === 'attendance.leave-management' ? 'text-blue-600' : ''); ?>"></i>
                    <span>Leave Management</span>
                </a>
                
                <!-- Official Business -->
                <a href="<?php echo e(route('attendance.official-business')); ?>" 
                   class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-white hover:text-blue-600 rounded-md transition-all duration-200 group <?php echo e($activeRoute === 'attendance.official-business' ? 'bg-white text-blue-600' : ''); ?>">
                    <i class="fas fa-briefcase mr-3 text-sm text-gray-400 group-hover:text-blue-600 <?php echo e($activeRoute === 'attendance.official-business' ? 'text-blue-600' : ''); ?>"></i>
        ...
        <a href="<?php echo e(route('documents.export')); ?>" class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-blue-600 rounded-lg transition-all duration-200 group">
...
<?php /**PATH C:\xampp\htdocs\GR8TECH\resources\views/components/dashboard/sidebar/navigation.blade.php ENDPATH**/ ?>