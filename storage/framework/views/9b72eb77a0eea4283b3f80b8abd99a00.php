...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-medium text-black hover:text-[#ED1C24] transition-colors dark:text-slate-100 dark:hover:text-[#ED1C24]">
                                Forgot password?
                            </a>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Xzanderyiel\Desktop\GR8TECH_Payroll-master\resources\views/auth/login.blade.php ENDPATH**/ ?>