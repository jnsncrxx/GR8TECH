                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $overtimeRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900" title="<?php echo e($request->reason); ?>"><?php echo e(\Illuminate\Support\Str::limit($request->reason, 30)); ?></div>
                                <?php if($request->status === 'rejected' && $request->rejection_reason): ?>
                                <div class="text-xs text-red-600 mt-1" title="<?php echo e($request->rejection_reason); ?>">
                                    <span class="font-medium">Admin Reason:</span> <?php echo e(\Illuminate\Support\Str::limit($request->rejection_reason, 30)); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="<?php echo e(in_array($user->role, ['admin', 'hr', 'manager']) ? 8 : 7); ?>" class="px-6 py-4 text-center">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $overtimeRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        ...
                        <div class="text-sm mb-3">
                            ...
                            <div class="font-medium"><?php echo e(\Illuminate\Support\Str::limit($request->reason, 50)); ?></div>
                        </div>
                        <?php if($request->status === 'rejected' && $request->rejection_reason): ?>
                        <div class="text-sm mb-3">
                            <div class="text-red-500 font-medium">Admin Reason</div>
                            <div class="font-medium text-red-600"><?php echo e(\Illuminate\Support\Str::limit($request->rejection_reason, 50)); ?></div>
                        </div>
                        <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (approveForm) {
        approveForm.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch(`<?php echo e(url('attendance/overtime')); ?>/${currentApproveId}/status`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    if (rejectForm) {
        rejectForm.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch(`<?php echo e(url('attendance/overtime')); ?>/${currentRejectId}/status`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
